...
class SearchEngine(BaseTool):
    ...
    def format_results(self, organic_results):
        """
        This method takes the organic search results and formats them into a list of strings.
        Each string contains the title, link, and snippet of a search result.
        """
        result_strings = []
    ...
    def run(self):
        """
        This method performs a search query using the Serper API.
        It sends a POST request with the search query and handles the response.
        If the response contains organic results, it formats them using the format_results method.
        """
...
class ScrapeWebsite(BaseTool):
    """
    ScrapeWebsite: A website scraping tool. You can use this tool to srape the content of a website.
    ...
    def run(self):
        ...
        try:
            # Makign a GET request to the website
            ...
            # Adding additional formatting for better readability
            ...
            print(f"An error occurred while scraping {self.website_url}: {e}")
            return {
